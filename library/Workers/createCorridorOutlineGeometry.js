...
define(['./when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-6e3c043b', './Matrix4-c68aaa66', './RuntimeError-5b606d78', './Cartesian2-e5f465dc', './WebGLConstants-30fc6f5c', './ComponentDatatype-a863af81', './GeometryAttribute-175788cc', './PrimitiveType-4c1d698a', './EnvironmentVariables-7e1444a0', './GeometryAttributes-cb18da36', './IndexDatatype-571b3b65', './IntersectionTests-6415221a', './Plane-f22e7e98', './GeometryOffsetAttribute-5cfc2755', './arrayRemoveDuplicates-7f5acdbe', './EllipsoidTangentPlane-ea3c97b6', './EllipsoidRhumbLine-e9bf1af4', './PolygonPipeline-6101abd8', './PolylineVolumeGeometryLibrary-2665c6ba', './EllipsoidGeodesic-80195a45', './PolylinePipeline-5d786ac6', './CorridorGeometryLibrary-8711bb47'], function (when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, RuntimeError, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EnvironmentVariables, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, GeometryOffsetAttribute, arrayRemoveDuplicates, EllipsoidTangentPlane, EllipsoidRhumbLine, PolygonPipeline, PolylineVolumeGeometryLibrary, EllipsoidGeodesic, PolylinePipeline, CorridorGeometryLibrary) { 'use strict';
    ...
    var cartesian1 = new Cartesian3.Cartesian3();
        ...
        function CorridorOutlineGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = 1 + positions.length * Cartesian3.Cartesian3.packedLength + Ellipsoid.Ellipsoid.packedLength + 6;
        }
    ...
    function createCorridorOutlineGeometry(corridorOutlineGeometry, offset) {
            ...
            corridorOutlineGeometry._ellipsoid = Ellipsoid.Ellipsoid.clone(corridorOutlineGeometry._ellipsoid);
