...
define(['./when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-239db6ff', './Matrix4-c68aaa66', './RuntimeError-5b606d78', './Cartesian2-e5f465dc', './WebGLConstants-30fc6f5c', './ComponentDatatype-a863af81', './GeometryAttribute-de79a9c2', './PrimitiveType-4c1d698a', './FeatureDetection-0c56f1be', './GeometryAttributes-cb18da36', './AttributeCompression-414035f7', './GeometryPipeline-5359445f', './EncodedCartesian3-24b261d0', './IndexDatatype-571b3b65', './IntersectionTests-927a9102', './Plane-f22e7e98', './VertexFormat-d75df48f', './arrayRemoveDuplicates-7f5acdbe', './EllipsoidTangentPlane-09857d60', './EllipsoidRhumbLine-e9bf1af4', './PolygonPipeline-5f144950', './BoundingRectangle-f1419893', './PolylineVolumeGeometryLibrary-cc2ecaa9', './EllipsoidGeodesic-80195a45', './PolylinePipeline-b60c6e78'], function (when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, RuntimeError, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, FeatureDetection, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, VertexFormat, arrayRemoveDuplicates, EllipsoidTangentPlane, EllipsoidRhumbLine, PolygonPipeline, BoundingRectangle, PolylineVolumeGeometryLibrary, EllipsoidGeodesic, PolylinePipeline) { 'use strict';
    ...
    function computeAttributes(combinedPositions, shape, boundingRectangle, vertexFormat) {
        ...
        function PolylineVolumeGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = numComponents + Ellipsoid.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 2;
        }
    ...
    function createPolylineVolumeGeometry(polylineVolumeGeometry, offset) {
            ...
            polylineVolumeGeometry._ellipsoid = Ellipsoid.Ellipsoid.clone(polylineVolumeGeometry._ellipsoid);
