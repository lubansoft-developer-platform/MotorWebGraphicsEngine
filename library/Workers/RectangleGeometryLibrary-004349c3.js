...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Transforms-0f2c35ae', './Cartesian2-ad22f1aa', './GeometryAttribute-cb1e0b8f'], function (exports, when, DeveloperError, _Math, Ellipsoid, Transforms, Cartesian2, GeometryAttribute) { 'use strict';
    ...
    var cos = Math.cos;
        ...
        var nwCartesian = new Ellipsoid.Cartesian3();
        var centerScratch = new Ellipsoid.Cartographic();
        var centerCartesian = new Ellipsoid.Cartesian3();
        ...
        function getRotationOptions(nwCorner, rotation, granularityX, granularityY, center, width, height) {
            ...
            nwCartesian = Ellipsoid.Cartesian3.subtract(nwCartesian, centerCartesian, nwCartesian);
            ...
            nwCartesian = Ellipsoid.Cartesian3.add(nwCartesian, centerCartesian, nwCartesian);
        ...
        RectangleGeometryLibrary.computeOptions = function(rectangle, granularity, rotation, stRotation, boundingRectangleScratch, nwCornerResult, stNwCornerResult) {
            ...
            if (rotation !== 0) {
                ...
                if (north < -_Math.CesiumMath.PI_OVER_TWO || north > _Math.CesiumMath.PI_OVER_TWO ||
                    ...
                    throw new DeveloperError.DeveloperError('Rotated rectangle is invalid.  It crosses over either the north or south pole.');
                }
                //>>includeEnd('debug')
...
//# sourceMappingURL=RectangleGeometryLibrary-004349c3.js.map
