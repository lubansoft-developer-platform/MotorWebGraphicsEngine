    ...
    /**
        ...
        Cartesian2.packArray = function(array, result) {
            ...
            if (!when.defined(result)) {
                ...
                throw new DeveloperError.DeveloperError('If result is a typed array, it must have exactly array.length * 2 elements');
        ...
        Cartesian2.unpackArray = function(array, result) {
            ...
            if (array.length % 2 !== 0) {
                throw new DeveloperError.DeveloperError('array length must be a multiple of 2.');
            }
            //>>includeEnd('debug');
...
//# sourceMappingURL=Cartesian2-ad22f1aa.js.map
