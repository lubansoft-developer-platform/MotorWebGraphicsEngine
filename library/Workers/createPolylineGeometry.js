...
define(['./when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-7fcb5ea2', './Matrix4-c68aaa66', './RuntimeError-5b606d78', './Cartesian2-e5f465dc', './WebGLConstants-30fc6f5c', './ComponentDatatype-a863af81', './GeometryAttribute-a2d75c0f', './PrimitiveType-4c1d698a', './EnvironmentVariables-cc0d0032', './GeometryAttributes-cb18da36', './IndexDatatype-571b3b65', './IntersectionTests-44b0fe21', './Plane-f22e7e98', './VertexFormat-d75df48f', './arrayRemoveDuplicates-7f5acdbe', './ArcType-2ee8dfbb', './EllipsoidRhumbLine-e9bf1af4', './EllipsoidGeodesic-80195a45', './PolylinePipeline-475595ab'], function (when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, RuntimeError, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EnvironmentVariables, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, VertexFormat, arrayRemoveDuplicates, ArcType, EllipsoidRhumbLine, EllipsoidGeodesic, PolylinePipeline) { 'use strict';
    ...
    var scratchInterpolateColorsArray = [];
        ...
        function PolylineGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = numComponents + Ellipsoid.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 4;
        }
    ...
    function createPolylineGeometry(polylineGeometry, offset) {
            ...
            polylineGeometry._ellipsoid = Ellipsoid.Ellipsoid.clone(polylineGeometry._ellipsoid);
