...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './Check-71521db1', './Math-4ee1dfaf'], function (exports, when, DeveloperError, Check, _Math) { 'use strict';
    ...
    /**
        ...
        Cartesian3.packArray = function(array, result) {
            ...
            if (!when.defined(result)) {
                ...
                throw new DeveloperError.DeveloperError('If result is a typed array, it must have exactly array.length * 3 elements');
        ...
        Cartesian3.unpackArray = function(array, result) {
            ...
            if (array.length % 3 !== 0) {
                throw new DeveloperError.DeveloperError('array length must be a multiple of 3.');
            }
            //>>includeEnd('debug');
        ...
        Cartesian3.fromDegreesArray = function(coordinates, ellipsoid, result) {
            ...
            if (coordinates.length < 2 || coordinates.length % 2 !== 0) {
                throw new DeveloperError.DeveloperError('the number of coordinates must be a multiple of 2 and at least 2');
            }
            //>>includeEnd('debug');
        ...
        Cartesian3.fromDegreesArrayHeights = function(coordinates, ellipsoid, result) {
            ...
            if (coordinates.length < 3 || coordinates.length % 3 !== 0) {
                throw new DeveloperError.DeveloperError('the number of coordinates must be a multiple of 3 and at least 3');
            }
            //>>includeEnd('debug');
    ...
    var scaleToGeodeticSurfaceIntersection = new Cartesian3();
        ...
        function scaleToGeodeticSurface(cartesian, oneOverRadii, oneOverRadiiSquared, centerToleranceSquared, result) {
            ...
            if (!when.defined(oneOverRadii)) {
                throw new DeveloperError.DeveloperError('oneOverRadii is required.');
            }
            if (!when.defined(oneOverRadiiSquared)) {
                throw new DeveloperError.DeveloperError('oneOverRadiiSquared is required.');
            }
            if (!when.defined(centerToleranceSquared)) {
                throw new DeveloperError.DeveloperError('centerToleranceSquared is required.');
            }
            //>>includeEnd('debug');
...
//# sourceMappingURL=Ellipsoid-e5098033.js.map
