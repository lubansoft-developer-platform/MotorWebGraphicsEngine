...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './GeometryOffsetAttribute-19130c81', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Transforms-0f2c35ae', './ComponentDatatype-f4fabeaa', './GeometryAttribute-cb1e0b8f', './PrimitiveType-4c1d698a', './GeometryAttributes-cb18da36', './IndexDatatype-ff78eee3'], function (exports, when, DeveloperError, GeometryOffsetAttribute, _Math, Ellipsoid, Transforms, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, IndexDatatype) { 'use strict';
    ...
    var defaultRadii = new Ellipsoid.Cartesian3(1.0, 1.0, 1.0);
        ...
        function EllipsoidOutlineGeometry(options) {
            ...
            if (stackPartitions < 1) {
                throw new DeveloperError.DeveloperError('options.stackPartitions cannot be less than 1');
            }
            if (slicePartitions < 0) {
                throw new DeveloperError.DeveloperError('options.slicePartitions cannot be less than 0');
            }
            if (subdivisions < 0) {
                throw new DeveloperError.DeveloperError('options.subdivisions must be greater than or equal to zero.');
            }
         ...
         * @type {Number}
         */
        EllipsoidOutlineGeometry.packedLength = 2 * (Ellipsoid.Cartesian3.packedLength) + 8;
        ...
        EllipsoidOutlineGeometry.createGeometry = function(ellipsoidGeometry) {
            ...
            var ellipsoid = Ellipsoid.Ellipsoid.fromCartesian3(radii);
...
//# sourceMappingURL=EllipsoidOutlineGeometry-776f2a96.js.map
