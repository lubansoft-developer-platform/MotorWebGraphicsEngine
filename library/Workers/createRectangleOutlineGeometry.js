...
define(['./when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-6e3c043b', './Matrix4-c68aaa66', './RuntimeError-5b606d78', './Cartesian2-e5f465dc', './WebGLConstants-30fc6f5c', './ComponentDatatype-a863af81', './GeometryAttribute-175788cc', './PrimitiveType-4c1d698a', './EnvironmentVariables-7e1444a0', './GeometryAttributes-cb18da36', './IndexDatatype-571b3b65', './GeometryOffsetAttribute-5cfc2755', './EllipsoidRhumbLine-e9bf1af4', './PolygonPipeline-6101abd8', './RectangleGeometryLibrary-47d40f56'], function (when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, RuntimeError, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EnvironmentVariables, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
    ...
    var bottomBoundingSphere = new Transforms.BoundingSphere();
         ...
         * @type {Number}
         */
        RectangleOutlineGeometry.packedLength = Cartesian2.Rectangle.packedLength + Ellipsoid.Ellipsoid.packedLength + 5;
