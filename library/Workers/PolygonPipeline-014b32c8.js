...
define(['exports', './when-7ef6387a', './Check-71521db1', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Cartesian2-ad22f1aa', './WebGLConstants-30fc6f5c', './ComponentDatatype-f4fabeaa', './GeometryAttribute-cb1e0b8f', './PrimitiveType-4c1d698a', './EllipsoidRhumbLine-89ea2621'], function (exports, when, Check, _Math, Ellipsoid, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EllipsoidRhumbLine) { 'use strict';
    ...
    var scaleToGeodeticHeightN = new Ellipsoid.Cartesian3();
        var scaleToGeodeticHeightP = new Ellipsoid.Cartesian3();
        ...
        var subdivisionV0Scratch = new Ellipsoid.Cartesian3();
        var subdivisionV1Scratch = new Ellipsoid.Cartesian3();
        var subdivisionV2Scratch = new Ellipsoid.Cartesian3();
        var subdivisionS0Scratch = new Ellipsoid.Cartesian3();
        var subdivisionS1Scratch = new Ellipsoid.Cartesian3();
        var subdivisionS2Scratch = new Ellipsoid.Cartesian3();
        var subdivisionMidScratch = new Ellipsoid.Cartesian3();
        ...
        PolygonPipeline.computeSubdivision = function(ellipsoid, positions, indices, granularity) {
            ...
            while (triangles.length > 0) {
                ...
                var v0 = Ellipsoid.Cartesian3.fromArray(subdividedPositions, i0 * 3, subdivisionV0Scratch);
                var v1 = Ellipsoid.Cartesian3.fromArray(subdividedPositions, i1 * 3, subdivisionV1Scratch);
                var v2 = Ellipsoid.Cartesian3.fromArray(subdividedPositions, i2 * 3, subdivisionV2Scratch);

                var s0 = Ellipsoid.Cartesian3.multiplyByScalar(Ellipsoid.Cartesian3.normalize(v0, subdivisionS0Scratch), radius, subdivisionS0Scratch);
                var s1 = Ellipsoid.Cartesian3.multiplyByScalar(Ellipsoid.Cartesian3.normalize(v1, subdivisionS1Scratch), radius, subdivisionS1Scratch);
                var s2 = Ellipsoid.Cartesian3.multiplyByScalar(Ellipsoid.Cartesian3.normalize(v2, subdivisionS2Scratch), radius, subdivisionS2Scratch);

                var g0 = Ellipsoid.Cartesian3.magnitudeSquared(Ellipsoid.Cartesian3.subtract(s0, s1, subdivisionMidScratch));
                var g1 = Ellipsoid.Cartesian3.magnitudeSquared(Ellipsoid.Cartesian3.subtract(s1, s2, subdivisionMidScratch));
                var g2 = Ellipsoid.Cartesian3.magnitudeSquared(Ellipsoid.Cartesian3.subtract(s2, s0, subdivisionMidScratch));
                ...
                if (max > minDistanceSqrd) {
                    if (g0 === max) {
                        ...
                        i = edges[edge];
                        if (!when.defined(i)) {
                            mid = Ellipsoid.Cartesian3.add(v0, v1, subdivisionMidScratch);
                            Ellipsoid.Cartesian3.multiplyByScalar(mid, 0.5, mid);
                        ...
                        i = edges[edge];
                        if (!when.defined(i)) {
                            mid = Ellipsoid.Cartesian3.add(v1, v2, subdivisionMidScratch);
                            Ellipsoid.Cartesian3.multiplyByScalar(mid, 0.5, mid);
                            subdividedPositions.push(mid.x, mid.y, mid.z);
                            i = subdividedPositions.length / 3 - 1;
                            edges[edge] = i;
                        ...
                        i = edges[edge];
                        if (!when.defined(i)) {
                            mid = Ellipsoid.Cartesian3.add(v2, v0, subdivisionMidScratch);
                            Ellipsoid.Cartesian3.multiplyByScalar(mid, 0.5, mid);
                            subdividedPositions.push(mid.x, mid.y, mid.z);
                            i = subdividedPositions.length / 3 - 1;
                            edges[edge] = i;
        ...
        var subdivisionC0Scratch = new Ellipsoid.Cartographic();
        var subdivisionC1Scratch = new Ellipsoid.Cartographic();
        var subdivisionC2Scratch = new Ellipsoid.Cartographic();
        var subdivisionCartographicScratch = new Ellipsoid.Cartographic();
                ...
                if (max > minDistance) {
                    if (g0 === max) {
                        ...
                        if (!when.defined(i)) {
                            ...
                            midCartesian3 = Ellipsoid.Cartesian3.fromRadians(mid.longitude, mid.latitude, midHeight, ellipsoid, subdivisionMidScratch);
        ...
        PolygonPipeline.scaleToGeodeticHeight = function(positions, height, ellipsoid, scaleToSurface) {
            ...
            if (when.defined(positions)) {
                ...
                for ( var i = 0; i < length; i += 3) {
                    Ellipsoid.Cartesian3.fromArray(positions, i, p);
                    ...
                    if (height !== 0) {
                        ...
                        Ellipsoid.Cartesian3.multiplyByScalar(n, height, n);
                        Ellipsoid.Cartesian3.add(p, n, p);
                    }
...
//# sourceMappingURL=PolygonPipeline-014b32c8.js.map
