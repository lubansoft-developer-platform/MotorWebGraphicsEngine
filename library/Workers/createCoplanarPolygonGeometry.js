...
define(['./when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-7fcb5ea2', './Matrix4-c68aaa66', './RuntimeError-5b606d78', './Cartesian2-e5f465dc', './WebGLConstants-30fc6f5c', './ComponentDatatype-a863af81', './GeometryAttribute-a2d75c0f', './PrimitiveType-4c1d698a', './EnvironmentVariables-cc0d0032', './GeometryAttributes-cb18da36', './AttributeCompression-414035f7', './GeometryPipeline-1550c59b', './EncodedCartesian3-24b261d0', './IndexDatatype-571b3b65', './IntersectionTests-44b0fe21', './Plane-f22e7e98', './VertexFormat-d75df48f', './arrayRemoveDuplicates-7f5acdbe', './BoundingRectangle-7439df6e', './EllipsoidTangentPlane-03282d71', './OrientedBoundingBox-f3c3f2ec', './CoplanarPolygonGeometryLibrary-4b393213', './GeometryInstance-2e04fc2f', './ArcType-2ee8dfbb', './EllipsoidRhumbLine-e9bf1af4', './PolygonPipeline-aaf99843', './PolygonGeometryLibrary-b7f635b6'], function (when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, RuntimeError, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EnvironmentVariables, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, VertexFormat, arrayRemoveDuplicates, BoundingRectangle, EllipsoidTangentPlane, OrientedBoundingBox, CoplanarPolygonGeometryLibrary, GeometryInstance, ArcType, EllipsoidRhumbLine, PolygonPipeline, PolygonGeometryLibrary) { 'use strict';
    ...
    var scratchPosition = new Cartesian3.Cartesian3();
        ...
        function createGeometryFromPolygon(polygon, vertexFormat, boundingRectangle, stRotation, projectPointTo2D, normal, tangent, bitangent) {
            ...
            if (stRotation !== 0.0) {
                ...
                if (vertexFormat.tangent || vertexFormat.bitangent) {
                    ...
                    var tangentRotation = Matrix4.Matrix3.fromQuaternion(rotation, tangentRotationScratch);

                    tangent = Cartesian3.Cartesian3.normalize(Matrix4.Matrix3.multiplyByVector(tangentRotation, tangent, tangent), tangent);
        ...
        function CoplanarPolygonGeometry(options) {
             ...
             * @type {Number}
             */
            this.packedLength = PolygonGeometryLibrary.PolygonGeometryLibrary.computeHierarchyPackedLength(polygonHierarchy) + VertexFormat.VertexFormat.packedLength + Ellipsoid.Ellipsoid.packedLength + 2;
        }
        ...
        CoplanarPolygonGeometry.createGeometry = function(polygonGeometry) {
            ...
            if (!Cartesian3.Cartesian3.equalsEpsilon(centerScratch, Cartesian3.Cartesian3.ZERO, Cartesian3.CesiumMath.EPSILON6)) {
