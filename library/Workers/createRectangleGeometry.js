...
define(['./when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-7fcb5ea2', './Matrix4-c68aaa66', './RuntimeError-5b606d78', './Cartesian2-e5f465dc', './WebGLConstants-30fc6f5c', './ComponentDatatype-a863af81', './GeometryAttribute-a2d75c0f', './PrimitiveType-4c1d698a', './EnvironmentVariables-cc0d0032', './GeometryAttributes-cb18da36', './AttributeCompression-414035f7', './GeometryPipeline-1550c59b', './EncodedCartesian3-24b261d0', './IndexDatatype-571b3b65', './IntersectionTests-44b0fe21', './Plane-f22e7e98', './GeometryOffsetAttribute-5cfc2755', './VertexFormat-d75df48f', './GeometryInstance-2e04fc2f', './EllipsoidRhumbLine-e9bf1af4', './PolygonPipeline-aaf99843', './RectangleGeometryLibrary-5164e58e'], function (when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, RuntimeError, Cartesian2, WebGLConstants, ComponentDatatype, GeometryAttribute, PrimitiveType, EnvironmentVariables, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, GeometryOffsetAttribute, VertexFormat, GeometryInstance, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
    ...
    var positionScratch = new Cartesian3.Cartesian3();
        ...
        var nwScratch = new Ellipsoid.Cartographic();
        var stNwScratch = new Ellipsoid.Cartographic();
         ...
         * @type {Number}
         */
        RectangleGeometry.packedLength = Cartesian2.Rectangle.packedLength + Ellipsoid.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 7;
        ...
        var centerScratch = new Ellipsoid.Cartographic();
        /**
    ...
    function createRectangleGeometry(rectangleGeometry, offset) {
            ...
            rectangleGeometry._ellipsoid = Ellipsoid.Ellipsoid.clone(rectangleGeometry._ellipsoid);
