...
define(['exports', './when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d'], function (exports, when, Check, Cartesian3, Ellipsoid) { 'use strict';
    ...
    var ViewerMode$1 = Object.freeze(ViewerMode);
    ...
    var EnvironmentVariables = {
        ...
        //outline
        _edgeColor : new Color(0.25, 0.25, 0.25, 1.0),
        ...
        _lazyLoadMaxByteLength : 10000000,
        _lazyLoadByteLength : 0,
        _viewerMode : ViewerMode$1.CIM
    };
    ...
    Object.defineProperties(EnvironmentVariables, {
        ...
        isBIMMode: {
            get: function () {
                return EnvironmentVariables._viewerMode === ViewerMode$1.BIM;
            }
        },
        ...
        isPlaneMode: {
            get: function () {
                return EnvironmentVariables._viewerMode === ViewerMode$1.PLANE;
            }
        },
        enableLazyLoad: {
            get: function () {
                return EnvironmentVariables._enableLazyLoad;
            },
            set: function (value) {
                EnvironmentVariables._enableLazyLoad = value;
            }
        },
        lazyLoadMaxByteLength: {
            get: function () {
                return EnvironmentVariables._lazyLoadMaxByteLength;
            },
            set: function (value) {
                if (value < 0.0) {
                    throw new Check.DeveloperError('lazyLoadMaxNum must be greater than or equal to 0.0');
                }
                EnvironmentVariables._lazyLoadMaxByteLength = value;
            }
        },
        lazyLoadByteLength: {
            get: function () {
                return EnvironmentVariables._lazyLoadByteLength;
            },
            set: function (value) {
                value = value < 0 ? 0 : value;
                EnvironmentVariables._lazyLoadByteLength = value;
            }
        },
        viewerMode: {
            get: function () {
                return EnvironmentVariables._viewerMode;
            },
            set: function (value) {
                EnvironmentVariables._viewerMode = value;
            }
        }
    });

    EnvironmentVariables.checkLoading = function(byteLength) {
        if(!EnvironmentVariables.enableLazyLoad){
            return true;
        }
        if(EnvironmentVariables.lazyLoadByteLength < EnvironmentVariables.lazyLoadMaxByteLength){
            EnvironmentVariables.lazyLoadByteLength += byteLength;
            return true;
        }
        return false;
    };

    EnvironmentVariables.getShaderDefines = function (definesArray) {
        if(EnvironmentVariables.isBIMMode){
            definesArray.push('BIM_MODE');
        }
        if(EnvironmentVariables.isPlaneMode){
            definesArray.push('PLANE_MODE');
        }
        if(EnvironmentVariables.isWebgl2){
            definesArray.push('WEBGL2');
        }
        return definesArray;
    };
...
//# sourceMappingURL=EnvironmentVariables-7e1444a0.js.map
