...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './Check-71521db1', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Cartesian2-ad22f1aa'], function (exports, when, DeveloperError, Check, _Math, Ellipsoid, Cartesian2) { 'use strict';
    ...
    var RIGHT_SHIFT = 1.0 / 256.0;
        ...
        AttributeCompression.octEncodeInRange = function(vector, rangeMax, result) {
            ...
            var magSquared = Ellipsoid.Cartesian3.magnitudeSquared(vector);
            if (Math.abs(magSquared - 1.0) > _Math.CesiumMath.EPSILON6) {
                throw new DeveloperError.DeveloperError('vector must be normalized.');
            }
            //>>includeEnd('debug');
        ...
        AttributeCompression.octDecodeInRange = function(x, y, rangeMax, result) {
            ...
            if (x < 0 || x > rangeMax || y < 0 || y > rangeMax) {
                throw new DeveloperError.DeveloperError('x and y must be unsigned normalized integers between 0 and ' + rangeMax);
            }
            //>>includeEnd('debug');
            ...
            return Ellipsoid.Cartesian3.normalize(result, result);
        };
        ...
        AttributeCompression.octDecodeFromCartesian4 = function(encoded, result) {
            ...
            if (x < 0 || x > 255 || y < 0 || y > 255 || z < 0 || z > 255 || w < 0 || w > 255) {
                throw new DeveloperError.DeveloperError('x, y, z, and w must be unsigned normalized integers between 0 and 255');
            }
            //>>includeEnd('debug');
...
//# sourceMappingURL=AttributeCompression-990711fd.js.map
