...
define(['exports', './when-7ef6387a', './Check-71521db1', './Math-4ee1dfaf', './Ellipsoid-e5098033'], function (exports, when, Check, _Math, Ellipsoid) { 'use strict';
    ...
    function setConstants(ellipsoidGeodesic) {
        ...
        function computeProperties(ellipsoidGeodesic, start, end, ellipsoid) {
            ...
            ellipsoidGeodesic._start = Ellipsoid.Cartographic.clone(start, ellipsoidGeodesic._start);
            ellipsoidGeodesic._end = Ellipsoid.Cartographic.clone(end, ellipsoidGeodesic._end);
        ...
        EllipsoidGeodesic.prototype.interpolateUsingSurfaceDistance = function(distance, result) {
            ...
            return new Ellipsoid.Cartographic(this._start.longitude + l, latitude, 0.0);
        };

    exports.EllipsoidGeodesic = EllipsoidGeodesic;

});
//# sourceMappingURL=EllipsoidGeodesic-57fcbe96.js.map
