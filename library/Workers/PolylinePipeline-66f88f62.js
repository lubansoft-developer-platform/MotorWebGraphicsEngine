...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Transforms-0f2c35ae', './IntersectionTests-1b541d86', './Plane-ed675142', './EllipsoidRhumbLine-89ea2621', './EllipsoidGeodesic-57fcbe96'], function (exports, when, DeveloperError, _Math, Ellipsoid, Transforms, IntersectionTests, Plane, EllipsoidRhumbLine, EllipsoidGeodesic) { 'use strict';
    ...
    /**
        ...
        var cartoScratch = new Ellipsoid.Cartographic();
        ...
        var wrapLongitudeOrigin = new Ellipsoid.Cartesian3();
        var wrapLongitudeXZNormal = new Ellipsoid.Cartesian3();
        var wrapLongitudeXZPlane = new Plane.Plane(Ellipsoid.Cartesian3.UNIT_X, 0.0);
        var wrapLongitudeYZNormal = new Ellipsoid.Cartesian3();
        var wrapLongitudeYZPlane = new Plane.Plane(Ellipsoid.Cartesian3.UNIT_X, 0.0);
        var wrapLongitudeIntersection = new Ellipsoid.Cartesian3();
        var wrapLongitudeOffset = new Ellipsoid.Cartesian3();
        ...
        var carto1 = new Ellipsoid.Cartographic();
        var carto2 = new Ellipsoid.Cartographic();
        var cartesian = new Ellipsoid.Cartesian3();
        var scaleFirst = new Ellipsoid.Cartesian3();
        var scaleLast = new Ellipsoid.Cartesian3();
        ...
        function generateCartesianArc(p0, p1, minDistance, ellipsoid, h0, h1, array, offset) {
            ...
            Ellipsoid.Cartesian3.pack(cart, array, index);
            index += 3;
        ...
        PolylinePipeline.wrapLongitude = function(positions, modelMatrix) {
            ...
            if (when.defined(positions) && positions.length > 0) {
                ...
                var origin = Transforms.Matrix4.multiplyByPoint(inverseModelMatrix, Ellipsoid.Cartesian3.ZERO, wrapLongitudeOrigin);
                var xzNormal = Ellipsoid.Cartesian3.normalize(Transforms.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Ellipsoid.Cartesian3.UNIT_Y, wrapLongitudeXZNormal), wrapLongitudeXZNormal);
                var xzPlane = Plane.Plane.fromPointNormal(origin, xzNormal, wrapLongitudeXZPlane);
                var yzNormal = Ellipsoid.Cartesian3.normalize(Transforms.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Ellipsoid.Cartesian3.UNIT_X, wrapLongitudeYZNormal), wrapLongitudeYZNormal);
                var yzPlane = Plane.Plane.fromPointNormal(origin, yzNormal, wrapLongitudeYZPlane);

                var count = 1;
                cartesians.push(Ellipsoid.Cartesian3.clone(positions[0]));
                ...
                for (var i = 1; i < length; ++i) {
                    ...
                    if (Plane.Plane.getPointDistance(yzPlane, prev) < 0.0 || Plane.Plane.getPointDistance(yzPlane, cur) < 0.0) {
                        ...
                        if (when.defined(intersection)) {
                            ...
                            var offset = Ellipsoid.Cartesian3.multiplyByScalar(xzNormal, 5.0e-9, wrapLongitudeOffset);
                            if (Plane.Plane.getPointDistance(xzPlane, prev) < 0.0) {
                                Ellipsoid.Cartesian3.negate(offset, offset);
                            }

                            cartesians.push(Ellipsoid.Cartesian3.add(intersection, offset, new Ellipsoid.Cartesian3()));
                    ...
                    cartesians.push(Ellipsoid.Cartesian3.clone(positions[i]));
                    count++;
        ...
        PolylinePipeline.generateArc = function(options) {
            ...
            if (!when.defined(positions)) {
                throw new DeveloperError.DeveloperError('options.positions is required.');
            }
            //>>includeEnd('debug');
            ...
            Ellipsoid.Cartesian3.pack(cart, newPositions, arrayLength - 3);
        ...
        PolylinePipeline.generateRhumbArc = function(options) {
            ...
            for (i = 0; i < length - 1; i++) {
                ...
                c0 = Ellipsoid.Cartographic.clone(c1, scratchCartographic0);
            }
        ...
        PolylinePipeline.generateCartesianArc = function(options) {
            ...
            for (var i = 0; i < size; i++) {
                newPositions[i] = Ellipsoid.Cartesian3.unpack(numberArray, i*3);
            }
            return newPositions;
        };
...
//# sourceMappingURL=PolylinePipeline-66f88f62.js.map
