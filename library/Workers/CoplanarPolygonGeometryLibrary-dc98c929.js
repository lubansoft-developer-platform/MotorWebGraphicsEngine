...
define(['exports', './Check-71521db1', './Ellipsoid-e5098033', './Transforms-0f2c35ae', './Cartesian2-ad22f1aa', './OrientedBoundingBox-c26eafff'], function (exports, Check, Ellipsoid, Transforms, Cartesian2, OrientedBoundingBox) { 'use strict';
    ...
    /**
        ...
        var scratchIntersectionPoint = new Ellipsoid.Cartesian3();
        var scratchXAxis = new Ellipsoid.Cartesian3();
        var scratchYAxis = new Ellipsoid.Cartesian3();
        var scratchZAxis = new Ellipsoid.Cartesian3();
        ...
        CoplanarPolygonGeometryLibrary.validOutline = function(positions) {
            ...
            var xMag = Ellipsoid.Cartesian3.magnitude(xAxis);
            var yMag = Ellipsoid.Cartesian3.magnitude(yAxis);
            var zMag = Ellipsoid.Cartesian3.magnitude(zAxis);
        ...
        CoplanarPolygonGeometryLibrary.computeProjectTo2DArguments = function(positions, centerResult, planeAxis1Result, planeAxis2Result) {
            ...
            Ellipsoid.Cartesian3.normalize(planeAxis1, planeAxis1Result);
            Ellipsoid.Cartesian3.normalize(planeAxis2, planeAxis2Result);
            Ellipsoid.Cartesian3.clone(orientedBoundingBox.center, centerResult);
            return true;
        };

        function projectTo2D(position, center, axis1, axis2, result) {
            var v = Ellipsoid.Cartesian3.subtract(position, center, scratchIntersectionPoint);
            var x = Ellipsoid.Cartesian3.dot(axis1, v);
            var y = Ellipsoid.Cartesian3.dot(axis2, v);
...
//# sourceMappingURL=CoplanarPolygonGeometryLibrary-dc98c929.js.map
