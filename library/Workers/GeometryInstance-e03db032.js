...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './Transforms-0f2c35ae'], function (exports, when, DeveloperError, Transforms) { 'use strict';
    ...
    /**
        ...
        function GeometryInstance(options) {
            ...
            if (!when.defined(options.geometry)) {
                throw new DeveloperError.DeveloperError('options.geometry is required.');
            }
            //>>includeEnd('debug');
...
//# sourceMappingURL=GeometryInstance-e03db032.js.map
