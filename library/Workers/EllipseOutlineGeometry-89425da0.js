...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './GeometryOffsetAttribute-19130c81', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Transforms-0f2c35ae', './ComponentDatatype-f4fabeaa', './GeometryAttribute-cb1e0b8f', './PrimitiveType-4c1d698a', './GeometryAttributes-cb18da36', './EllipseGeometryLibrary-65dcd445', './IndexDatatype-ff78eee3'], function (exports, when, DeveloperError, GeometryOffsetAttribute, _Math, Ellipsoid, Transforms, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, EllipseGeometryLibrary, IndexDatatype) { 'use strict';
    ...
    var scratchCartesian1 = new Ellipsoid.Cartesian3();
        ...
        function EllipseOutlineGeometry(options) {
            ...
            if (!when.defined(semiMajorAxis)) {
                throw new DeveloperError.DeveloperError('semiMajorAxis is required.');
            }
            if (!when.defined(semiMinorAxis)) {
                throw new DeveloperError.DeveloperError('semiMinorAxis is required.');
            }
         ...
         * @type {Number}
         */
        EllipseOutlineGeometry.packedLength = Ellipsoid.Cartesian3.packedLength + Ellipsoid.Ellipsoid.packedLength + 8;
...
//# sourceMappingURL=EllipseOutlineGeometry-89425da0.js.map
