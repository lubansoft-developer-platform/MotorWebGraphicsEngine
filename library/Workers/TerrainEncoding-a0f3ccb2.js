...
define(['exports', './when-7ef6387a', './Check-ed6a1804', './Math-85667bf9', './Ellipsoid-1cbb4ac9', './Transforms-c20c38d0', './Cartesian2-73569d25', './ComponentDatatype-a863af81', './AttributeCompression-5e3c38a2'], function (exports, when, Check, _Math, Ellipsoid, Transforms, Cartesian2, ComponentDatatype, AttributeCompression) { 'use strict';
    ...
    /**
        ...
        function EllipsoidalOccluder(ellipsoid, cameraPosition) {
            ...
            this._cameraPosition = new Ellipsoid.Cartesian3();
            this._cameraPositionInScaledSpace = new Ellipsoid.Cartesian3();
        ...
        Object.defineProperties(EllipsoidalOccluder.prototype, {
            ...
            cameraPosition : {
                ...
                set : function(cameraPosition) {
                    ...
                    var vhMagnitudeSquared = Ellipsoid.Cartesian3.magnitudeSquared(cv) - 1.0;

                    Ellipsoid.Cartesian3.clone(cameraPosition, this._cameraPosition);
        ...
        var scratchCartesian = new Ellipsoid.Cartesian3();
        ...
        var scratchCameraPositionInScaledSpaceShrunk = new Ellipsoid.Cartesian3();
        ...
        var scratchEllipsoidShrunk = Ellipsoid.Ellipsoid.clone(Ellipsoid.Ellipsoid.UNIT_SPHERE);
        ...
        EllipsoidalOccluder.prototype.computeHorizonCullingPointFromRectangle = function(rectangle, ellipsoid, result) {
            ...
            if (Ellipsoid.Cartesian3.magnitude(bs.center) < 0.1 * ellipsoid.minimumRadius) {
                return undefined;
            }
        ...
        var scratchEllipsoidShrunkRadii = new Ellipsoid.Cartesian3();

        function getPossiblyShrunkEllipsoid(ellipsoid, minimumHeight, result) {
            if (when.defined(minimumHeight) && minimumHeight < 0.0 && ellipsoid.minimumRadius > -minimumHeight) {
                var ellipsoidShrunkRadii = Ellipsoid.Cartesian3.fromElements(
                    ellipsoid.radii.x + minimumHeight,
                    ellipsoid.radii.y + minimumHeight,
                    ellipsoid.radii.z + minimumHeight,
                    scratchEllipsoidShrunkRadii
                );
                ellipsoid = Ellipsoid.Ellipsoid.fromCartesian3(ellipsoidShrunkRadii, result);
            }
            return ellipsoid;
        }
        ...
        var positionScratch = new Ellipsoid.Cartesian3();
        ...
        function isScaledSpacePointVisible(occludeeScaledSpacePosition, cameraPositionInScaledSpace, distanceToLimbInScaledSpaceSquared) {
            ...
            var vt = Ellipsoid.Cartesian3.subtract(occludeeScaledSpacePosition, cv, scratchCartesian);
            var vtDotVc = -Ellipsoid.Cartesian3.dot(vt, cv);
            // If vhMagnitudeSquared < 0 then we are below the surface of the ellipsoid and
            // in this case, set the culling plane to be on V.
            var isOccluded = vhMagnitudeSquared < 0 ? vtDotVc > 0 : (vtDotVc > vhMagnitudeSquared &&
                             vtDotVc * vtDotVc / Ellipsoid.Cartesian3.magnitudeSquared(vt) > vhMagnitudeSquared);
            return !isOccluded;
        }

        var scaledSpaceScratch = new Ellipsoid.Cartesian3();
        var directionScratch = new Ellipsoid.Cartesian3();

        function computeMagnitude(ellipsoid, position, scaledSpaceDirectionToPoint) {
            var scaledSpacePosition = ellipsoid.transformPositionToScaledSpace(position, scaledSpaceScratch);
            var magnitudeSquared = Ellipsoid.Cartesian3.magnitudeSquared(scaledSpacePosition);
            var magnitude = Math.sqrt(magnitudeSquared);
            var direction = Ellipsoid.Cartesian3.divideByScalar(scaledSpacePosition, magnitude, directionScratch);

            // For the purpose of this computation, points below the ellipsoid are consider to be on it instead.
            magnitudeSquared = Math.max(1.0, magnitudeSquared);
            magnitude = Math.max(1.0, magnitude);

            var cosAlpha = Ellipsoid.Cartesian3.dot(direction, scaledSpaceDirectionToPoint);
            var sinAlpha = Ellipsoid.Cartesian3.magnitude(Ellipsoid.Cartesian3.cross(direction, scaledSpaceDirectionToPoint, direction));
        ...
        function magnitudeToPoint(scaledSpaceDirectionToPoint, resultMagnitude, result) {
            ...
            return Ellipsoid.Cartesian3.multiplyByScalar(scaledSpaceDirectionToPoint, resultMagnitude, result);
        }

        var directionToPointScratch = new Ellipsoid.Cartesian3();

        function computeScaledSpaceDirectionToPoint(ellipsoid, directionToPoint) {
            if (Ellipsoid.Cartesian3.equals(directionToPoint, Ellipsoid.Cartesian3.ZERO)) {
                return directionToPoint;
            }

            ellipsoid.transformPositionToScaledSpace(directionToPoint, directionToPointScratch);
            return Ellipsoid.Cartesian3.normalize(directionToPointScratch, directionToPointScratch);
        }
    ...
    var cartesian3Scratch = new Ellipsoid.Cartesian3();
        var cartesian3DimScratch = new Ellipsoid.Cartesian3();
        ...
        function TerrainEncoding(axisAlignedBoundingBox, minimumHeight, maximumHeight, fromENU, hasVertexNormals, hasWebMercatorT) {
            ...
            if (when.defined(axisAlignedBoundingBox) && when.defined(minimumHeight) && when.defined(maximumHeight) && when.defined(fromENU)) {
                ...
                var dimensions = Ellipsoid.Cartesian3.subtract(maximum, minimum, cartesian3DimScratch);
                var hDim = maximumHeight - minimumHeight;
                var maxDim = Math.max(Ellipsoid.Cartesian3.maximumComponent(dimensions), hDim);
                ...
                var translation = Ellipsoid.Cartesian3.negate(minimum, cartesian3Scratch);
                ...
                Transforms.Matrix4.setTranslation(matrix, Ellipsoid.Cartesian3.ZERO, matrix);
        ...
        TerrainEncoding.prototype.encode = function(vertexBuffer, bufferIndex, position, uv, height, normalToPack, webMercatorT) {
            ...
            if (this.quantization === TerrainQuantization$1.BITS12) {
                ...
                Ellipsoid.Cartesian3.subtract(position, this.center, cartesian3Scratch);
        ...
        TerrainEncoding.prototype.decodePosition = function(buffer, index, result) {
            ...
            return Ellipsoid.Cartesian3.add(result, this.center, result);
        };
        ...
        TerrainEncoding.clone = function(encoding, result) {
            ...
            result.center = Ellipsoid.Cartesian3.clone(encoding.center);
...
//# sourceMappingURL=TerrainEncoding-a0f3ccb2.js.map
