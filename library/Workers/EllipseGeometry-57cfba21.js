...
define(['exports', './when-7ef6387a', './Check-ed6a1804', './Cartesian3-18c04df5', './Ellipsoid-f29f901d', './Transforms-7fcb5ea2', './Matrix4-c68aaa66', './Cartesian2-e5f465dc', './ComponentDatatype-a863af81', './GeometryAttribute-a2d75c0f', './PrimitiveType-4c1d698a', './GeometryAttributes-cb18da36', './GeometryPipeline-1550c59b', './IndexDatatype-571b3b65', './GeometryOffsetAttribute-5cfc2755', './VertexFormat-d75df48f', './GeometryInstance-2e04fc2f', './EllipseGeometryLibrary-10792b32'], function (exports, when, Check, Cartesian3, Ellipsoid, Transforms, Matrix4, Cartesian2, ComponentDatatype, GeometryAttribute, PrimitiveType, GeometryAttributes, GeometryPipeline, IndexDatatype, GeometryOffsetAttribute, VertexFormat, GeometryInstance, EllipseGeometryLibrary) { 'use strict';
    ...
    var scratchCartesian1 = new Cartesian3.Cartesian3();
         ...
         * @type {Number}
         */
        EllipseGeometry.packedLength = Cartesian3.Cartesian3.packedLength + Ellipsoid.Ellipsoid.packedLength + VertexFormat.VertexFormat.packedLength + 9;
...
//# sourceMappingURL=EllipseGeometry-57cfba21.js.map
