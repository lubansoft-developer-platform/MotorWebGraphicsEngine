...
define(['exports', './when-7ef6387a', './DeveloperError-101d8eb9', './Check-71521db1', './Math-4ee1dfaf', './Ellipsoid-e5098033', './Transforms-0f2c35ae', './Cartesian2-ad22f1aa', './ComponentDatatype-f4fabeaa', './GeometryAttribute-cb1e0b8f', './PrimitiveType-4c1d698a', './AttributeCompression-990711fd', './EncodedCartesian3-1498be0b', './IndexDatatype-ff78eee3', './IntersectionTests-1b541d86', './Plane-ed675142'], function (exports, when, DeveloperError, Check, _Math, Ellipsoid, Transforms, Cartesian2, ComponentDatatype, GeometryAttribute, PrimitiveType, AttributeCompression, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane) { 'use strict';

    var scratchCartesian1 = new Ellipsoid.Cartesian3();
        var scratchCartesian2 = new Ellipsoid.Cartesian3();
        ...
        function barycentricCoordinates(point, p0, p1, p2, result) {
            ...
            if (!when.defined(result)) {
                result = new Ellipsoid.Cartesian3();
            }
            ...
            if(!when.defined(p0.z)) {
                if (Cartesian2.Cartesian2.equalsEpsilon(point, p0, _Math.CesiumMath.EPSILON14)) {
                    return Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.UNIT_X, result);
                }
                if (Cartesian2.Cartesian2.equalsEpsilon(point, p1, _Math.CesiumMath.EPSILON14)) {
                    return Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.UNIT_Y, result);
                }
                if (Cartesian2.Cartesian2.equalsEpsilon(point, p2, _Math.CesiumMath.EPSILON14)) {
                    return Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.UNIT_Z, result);
                }
                ...
                if (Ellipsoid.Cartesian3.equalsEpsilon(point, p0, _Math.CesiumMath.EPSILON14)) {
                    return Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.UNIT_X, result);
                }
                if (Ellipsoid.Cartesian3.equalsEpsilon(point, p1, _Math.CesiumMath.EPSILON14)) {
                    return Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.UNIT_Y, result);
                }
                if (Ellipsoid.Cartesian3.equalsEpsilon(point, p2, _Math.CesiumMath.EPSILON14)) {
                    return Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.UNIT_Z, result);
                }

                v0 = Ellipsoid.Cartesian3.subtract(p1, p0, scratchCartesian1);
                v1 = Ellipsoid.Cartesian3.subtract(p2, p0, scratchCartesian2);
                v2 = Ellipsoid.Cartesian3.subtract(point, p0, scratchCartesian3);

                dot00 = Ellipsoid.Cartesian3.dot(v0, v0);
                dot01 = Ellipsoid.Cartesian3.dot(v0, v1);
                dot02 = Ellipsoid.Cartesian3.dot(v0, v2);
                dot11 = Ellipsoid.Cartesian3.dot(v1, v1);
                dot12 = Ellipsoid.Cartesian3.dot(v1, v2);
            }
    ...
    /**
        ...
        Tipsify.calculateACMR = function(options) {
            ...
            if (!when.defined(indices)) {
                throw new DeveloperError.DeveloperError('indices is required.');
            }
            //>>includeEnd('debug');
            ...
            if (numIndices < 3 || numIndices % 3 !== 0) {
                throw new DeveloperError.DeveloperError('indices length must be a multiple of three.');
            }
            if (maximumIndex <= 0) {
                throw new DeveloperError.DeveloperError('maximumIndex must be greater than zero.');
            }
            if (cacheSize < 3) {
                throw new DeveloperError.DeveloperError('cacheSize must be greater than two.');
            }
            //>>includeEnd('debug');
    ...
    /**
        ...
        GeometryPipeline.toWireframe = function(geometry) {
            ...
            if (!when.defined(geometry)) {
                throw new DeveloperError.DeveloperError('geometry is required.');
            }
            //>>includeEnd('debug');
            ...
            if (when.defined(indices)) {
                switch (geometry.primitiveType) {
                    ...
                    //>>includeStart('debug', pragmas.debug);
                    default:
                        throw new DeveloperError.DeveloperError('geometry.primitiveType must be TRIANGLES, TRIANGLE_STRIP, or TRIANGLE_FAN.');
                    //>>includeEnd('debug');
                }
        ...
        GeometryPipeline.createLineSegmentsForVectors = function(geometry, attributeName, length) {
            ...
            if (!when.defined(geometry.attributes.position)) {
                throw new DeveloperError.DeveloperError('geometry.attributes.position is required.');
            }
            if (!when.defined(geometry.attributes[attributeName])) {
                throw new DeveloperError.DeveloperError('geometry.attributes must have an attribute with the same name as the attributeName parameter, ' + attributeName + '.');
            }
            //>>includeEnd('debug');
        ...
        GeometryPipeline.fitToUnsignedShortIndices = function(geometry) {
            ...
            if ((when.defined(geometry.indices)) &&
                ...
                throw new DeveloperError.DeveloperError('geometry.primitiveType must equal to PrimitiveType.TRIANGLES, PrimitiveType.LINES, or PrimitiveType.POINTS.');
            }
            //>>includeEnd('debug');
        ...
        var scratchProjectTo2DCartesian3 = new Ellipsoid.Cartesian3();
        var scratchProjectTo2DCartographic = new Ellipsoid.Cartographic();
        ...
        GeometryPipeline.projectTo2D = function(geometry, attributeName, attributeName3D, attributeName2D, projection) {
            ...
            if (!when.defined(attributeName)) {
                throw new DeveloperError.DeveloperError('attributeName is required.');
            }
            if (!when.defined(attributeName3D)) {
                throw new DeveloperError.DeveloperError('attributeName3D is required.');
            }
            if (!when.defined(attributeName2D)) {
                throw new DeveloperError.DeveloperError('attributeName2D is required.');
            }
            if (!when.defined(geometry.attributes[attributeName])) {
                throw new DeveloperError.DeveloperError('geometry must have attribute matching the attributeName argument: ' + attributeName + '.');
            }
            if (geometry.attributes[attributeName].componentDatatype !== ComponentDatatype.ComponentDatatype.DOUBLE) {
                throw new DeveloperError.DeveloperError('The attribute componentDatatype must be ComponentDatatype.DOUBLE.');
            }
            //>>includeEnd('debug');
            ...
            for ( var i = 0; i < values3D.length; i += 3) {
                var value = Ellipsoid.Cartesian3.fromArray(values3D, i, scratchProjectTo2DCartesian3);

                var lonLat = ellipsoid.cartesianToCartographic(value, scratchProjectTo2DCartographic);
                //>>includeStart('debug', pragmas.debug);
                if (!when.defined(lonLat)) {
                    throw new DeveloperError.DeveloperError('Could not project point (' + value.x + ', ' + value.y + ', ' + value.z + ') to 2D.');
                }
                //>>includeEnd('debug');
        ...
        GeometryPipeline.encodeAttribute = function(geometry, attributeName, attributeHighName, attributeLowName) {
            ...
            if (!when.defined(attributeHighName)) {
                throw new DeveloperError.DeveloperError('attributeHighName is required.');
            }
            if (!when.defined(attributeLowName)) {
                throw new DeveloperError.DeveloperError('attributeLowName is required.');
            }
            if (!when.defined(geometry.attributes[attributeName])) {
                throw new DeveloperError.DeveloperError('geometry must have attribute matching the attributeName argument: ' + attributeName + '.');
            }
        ...
        var scratchCartesian3$1 = new Ellipsoid.Cartesian3();
        ...
        function transformPoint(matrix, attribute) {
            if (when.defined(attribute)) {
                ...
                for (var i = 0; i < length; i += 3) {
                    Ellipsoid.Cartesian3.unpack(values, i, scratchCartesian3$1);
                    Transforms.Matrix4.multiplyByPoint(matrix, scratchCartesian3$1, scratchCartesian3$1);
                    Ellipsoid.Cartesian3.pack(scratchCartesian3$1, values, i);
                }
            }
        }
        ...
        function transformVector(matrix, attribute) {
            if (when.defined(attribute)) {
                ...
                for (var i = 0; i < length; i += 3) {
                    ...
                    scratchCartesian3$1 = Ellipsoid.Cartesian3.normalize(scratchCartesian3$1, scratchCartesian3$1);
                    Ellipsoid.Cartesian3.pack(scratchCartesian3$1, values, i);
                }
            }
        }
        ...
        GeometryPipeline.transformToWorldCoordinates = function(instance) {
            ...
            if (!when.defined(instance)) {
                throw new DeveloperError.DeveloperError('instance is required.');
            }
            //>>includeEnd('debug');
        ...
        var tempScratch = new Ellipsoid.Cartesian3();
        ...
        function combineGeometries(instances, propertyName) {
            ...
            for (i = 1; i < length; ++i) {
                if (!Transforms.Matrix4.equals(instances[i].modelMatrix, m)) {
                    throw new DeveloperError.DeveloperError('All instances must have the same modelMatrix.');
                }
                if ((when.defined(instances[i][propertyName].indices)) !== haveIndices) {
                    throw new DeveloperError.DeveloperError('All instance geometries must have an indices or not have one.');
                }
                if (instances[i][propertyName].primitiveType !== primitiveType) {
                    throw new DeveloperError.DeveloperError('All instance geometries must have the same primitiveType.');
                }
            }
            //>>includeEnd('debug');
            ...
            var center = new Ellipsoid.Cartesian3();
            var radius = 0.0;
            var bs;
            ...
            for (i = 0; i < length; ++i) {
                ...
                Ellipsoid.Cartesian3.add(bs.center, center, center);
            }

            if (when.defined(center)) {
                Ellipsoid.Cartesian3.divideByScalar(center, length, center);

                for (i = 0; i < length; ++i) {
                    bs = instances[i][propertyName].boundingSphere;
                    var tempRadius = Ellipsoid.Cartesian3.magnitude(Ellipsoid.Cartesian3.subtract(bs.center, center, tempScratch)) + bs.radius;
        ...
        GeometryPipeline.combineInstances = function(instances) {
            ...
            if ((!when.defined(instances)) || (instances.length < 1)) {
                throw new DeveloperError.DeveloperError('instances is required and must have length greater than zero.');
            }
            //>>includeEnd('debug');
        ...
        var normal = new Ellipsoid.Cartesian3();
        var v0 = new Ellipsoid.Cartesian3();
        var v1 = new Ellipsoid.Cartesian3();
        var v2 = new Ellipsoid.Cartesian3();
        ...
        GeometryPipeline.computeNormal = function(geometry) {
            ...
            if (!when.defined(geometry.attributes.position) || !when.defined(geometry.attributes.position.values)) {
                throw new DeveloperError.DeveloperError('geometry.attributes.position.values is required.');
            }
            if (!when.defined(geometry.indices)) {
                throw new DeveloperError.DeveloperError('geometry.indices is required.');
            }
            if (geometry.indices.length < 2 || geometry.indices.length % 3 !== 0) {
                throw new DeveloperError.DeveloperError('geometry.indices length must be greater than 0 and be a multiple of 3.');
            }
            if (geometry.primitiveType !== PrimitiveType.PrimitiveType.TRIANGLES) {
                throw new DeveloperError.DeveloperError('geometry.primitiveType must be PrimitiveType.TRIANGLES.');
            }
            //>>includeEnd('debug');
            ...
            for (i = 0; i < numIndices; i += 3) {
                ...
                Ellipsoid.Cartesian3.subtract(v1, v0, v1);
                Ellipsoid.Cartesian3.subtract(v2, v0, v2);
                normalsPerTriangle[j] = Ellipsoid.Cartesian3.cross(v1, v2, new Ellipsoid.Cartesian3());
                j++;
            }
            ...
            for (i = 0; i < numVertices; i++) {
                ...
                Ellipsoid.Cartesian3.clone(Ellipsoid.Cartesian3.ZERO, normal);
                if (vertexNormalData.count > 0) {
                    for (j = 0; j < vertexNormalData.count; j++) {
                        Ellipsoid.Cartesian3.add(normal, normalsPerTriangle[normalIndices[vertexNormalData.indexOffset + j]], normal);
                    }

                    // We can run into an issue where a vertex is used with 2 primitives that have opposite winding order.
                    if (Ellipsoid.Cartesian3.equalsEpsilon(Ellipsoid.Cartesian3.ZERO, normal, _Math.CesiumMath.EPSILON10)) {
                        Ellipsoid.Cartesian3.clone(normalsPerTriangle[normalIndices[vertexNormalData.indexOffset]], normal);
                    }
                }
                ...
                Ellipsoid.Cartesian3.normalize(normal, normal);
        ...
        var normalScale = new Ellipsoid.Cartesian3();
        var tScratch = new Ellipsoid.Cartesian3();
        ...
        GeometryPipeline.computeTangentAndBitangent = function(geometry) {
            ...
            if (!when.defined(attributes.normal) || !when.defined(attributes.normal.values)) {
                throw new DeveloperError.DeveloperError('geometry.attributes.normal.values is required.');
            }
            if (!when.defined(attributes.st) || !when.defined(attributes.st.values)) {
                throw new DeveloperError.DeveloperError('geometry.attributes.st.values is required.');
            }
            if (!when.defined(indices)) {
                throw new DeveloperError.DeveloperError('geometry.indices is required.');
            }
            ...
            for (i = 0; i < numVertices; i++) {
                ...
                var n = Ellipsoid.Cartesian3.fromArray(normals, i03, normalScratch);
                var t = Ellipsoid.Cartesian3.fromArray(tan1, i03, tScratch);
                var scalar = Ellipsoid.Cartesian3.dot(n, t);
                Ellipsoid.Cartesian3.multiplyByScalar(n, scalar, normalScale);
                Ellipsoid.Cartesian3.normalize(Ellipsoid.Cartesian3.subtract(t, normalScale, t), t);

                tangentValues[i03] = t.x;
                tangentValues[i13] = t.y;
                tangentValues[i23] = t.z;

                Ellipsoid.Cartesian3.normalize(Ellipsoid.Cartesian3.cross(n, t, t), t);
        ...
        var toEncode1 = new Ellipsoid.Cartesian3();
        var toEncode2 = new Ellipsoid.Cartesian3();
        var toEncode3 = new Ellipsoid.Cartesian3();
        ...
        GeometryPipeline.compressVertices = function(geometry) {
            ...
            if (when.defined(extrudeAttribute)) {
                ...
                var i2 = 0;
                for (i = 0; i < numVertices; ++i) {
                    Ellipsoid.Cartesian3.fromArray(extrudeDirections, i * 3.0, toEncode1);
                    if (Ellipsoid.Cartesian3.equals(toEncode1, Ellipsoid.Cartesian3.ZERO)) {
                        i2 += 2;
                        continue;
                    }
            ...
            for (i = 0; i < numVertices; ++i) {
                ...
                if (hasNormal && when.defined(tangents) && when.defined(bitangents)) {
                    Ellipsoid.Cartesian3.fromArray(normals, index, toEncode1);
                    Ellipsoid.Cartesian3.fromArray(tangents, index, toEncode2);
                    Ellipsoid.Cartesian3.fromArray(bitangents, index, toEncode3);
                    ...
                    if (hasTangent) {
                        Ellipsoid.Cartesian3.fromArray(tangents, index, toEncode1);
                        compressedAttributes[normalIndex++] = AttributeCompression.AttributeCompression.octEncodeFloat(toEncode1);
                    }

                    if (hasBitangent) {
                        Ellipsoid.Cartesian3.fromArray(bitangents, index, toEncode1);
                        compressedAttributes[normalIndex++] = AttributeCompression.AttributeCompression.octEncodeFloat(toEncode1);
                    }
                }
            }
        ...
        function indexTriangles(geometry) {
            ...
            if (numberOfVertices < 3) {
                throw new DeveloperError.DeveloperError('The number of vertices must be at least three.');
            }
            if (numberOfVertices % 3 !== 0) {
                throw new DeveloperError.DeveloperError('The number of vertices must be a multiple of three.');
            }
            //>>includeEnd('debug');
        ...
        function indexTriangleStrip(geometry) {
            ...
            //>>includeStart('debug', pragmas.debug);
            if (numberOfVertices < 3) {
                throw new DeveloperError.DeveloperError('The number of vertices must be at least 3.');
            }
            //>>includeEnd('debug');
        ...
        function indexLines(geometry) {
            ...
            if (numberOfVertices < 2) {
                throw new DeveloperError.DeveloperError('The number of vertices must be at least two.');
            }
            if (numberOfVertices % 2 !== 0) {
                throw new DeveloperError.DeveloperError('The number of vertices must be a multiple of 2.');
            }
            //>>includeEnd('debug');
        ...
        var c3 = new Ellipsoid.Cartesian3();
        function getXZIntersectionOffsetPoints(p, p1, u1, v1) {
            Ellipsoid.Cartesian3.add(p, Ellipsoid.Cartesian3.multiplyByScalar(Ellipsoid.Cartesian3.subtract(p1, p, c3), p.y/(p.y-p1.y), c3), u1);
            Ellipsoid.Cartesian3.clone(u1, v1);
            offsetPointFromXZPlane(u1, true);
            offsetPointFromXZPlane(v1, false);
        }

        var u1 = new Ellipsoid.Cartesian3();
        var u2 = new Ellipsoid.Cartesian3();
        var q1 = new Ellipsoid.Cartesian3();
        var q2 = new Ellipsoid.Cartesian3();
        ...
        var interpolateAndPackCartesian3 = generateBarycentricInterpolateFunction(Ellipsoid.Cartesian3, 3);
        ...
        var p0Scratch = new Ellipsoid.Cartesian3();
        var p1Scratch = new Ellipsoid.Cartesian3();
        var p2Scratch = new Ellipsoid.Cartesian3();
        var barycentricScratch = new Ellipsoid.Cartesian3();
        ...
        function computeTriangleAttributes(i0, i1, i2, point, positions, normals, tangents, bitangents, texCoords, extrudeDirections, applyOffset, currentAttributes, customAttributeNames, customAttributesLength, allAttributes, insertedIndex) {
            ...
            var p0 = Ellipsoid.Cartesian3.fromArray(positions, i0 * 3, p0Scratch);
            var p1 = Ellipsoid.Cartesian3.fromArray(positions, i1 * 3, p1Scratch);
            var p2 = Ellipsoid.Cartesian3.fromArray(positions, i2 * 3, p2Scratch);
            ...
            if (when.defined(extrudeDirections)) {
                var d0 = Ellipsoid.Cartesian3.fromArray(extrudeDirections, i0 * 3, p0Scratch);
                var d1 = Ellipsoid.Cartesian3.fromArray(extrudeDirections, i1 * 3, p1Scratch);
                var d2 = Ellipsoid.Cartesian3.fromArray(extrudeDirections, i2 * 3, p2Scratch);

                Ellipsoid.Cartesian3.multiplyByScalar(d0, coords.x, d0);
                Ellipsoid.Cartesian3.multiplyByScalar(d1, coords.y, d1);
                Ellipsoid.Cartesian3.multiplyByScalar(d2, coords.z, d2);

                var direction;
                if (!Ellipsoid.Cartesian3.equals(d0, Ellipsoid.Cartesian3.ZERO) || !Ellipsoid.Cartesian3.equals(d1, Ellipsoid.Cartesian3.ZERO) || !Ellipsoid.Cartesian3.equals(d2, Ellipsoid.Cartesian3.ZERO)) {
                    direction = Ellipsoid.Cartesian3.add(d0, d1, d0);
                    Ellipsoid.Cartesian3.add(direction, d2, direction);
                    Ellipsoid.Cartesian3.normalize(direction, direction);
                } else {
                    direction = p0Scratch;
                    direction.x = 0;
                    direction.y = 0;
                ...
                Ellipsoid.Cartesian3.pack(direction, currentAttributes.extrudeDirection.values, insertedIndex * 3);
            }
        ...
        function splitLongitudeTriangles(instance) {
            ...
            for (i = 0; i < len; i += 3) {
                ...
                var p0 = Ellipsoid.Cartesian3.fromArray(positions, i0 * 3);
                var p1 = Ellipsoid.Cartesian3.fromArray(positions, i1 * 3);
                var p2 = Ellipsoid.Cartesian3.fromArray(positions, i2 * 3);
        ...
        var xzPlane = Plane.Plane.fromPointNormal(Ellipsoid.Cartesian3.ZERO, Ellipsoid.Cartesian3.UNIT_Y);

        var offsetScratch = new Ellipsoid.Cartesian3();
        var offsetPointScratch = new Ellipsoid.Cartesian3();
        ...
        function computeLineAttributes(i0, i1, point, positions, insertIndex, currentAttributes, applyOffset) {
            ...
            var p0 = Ellipsoid.Cartesian3.fromArray(positions, i0 * 3, p0Scratch);
            if (Ellipsoid.Cartesian3.equalsEpsilon(p0, point, _Math.CesiumMath.EPSILON10)) {
        ...
        function splitLongitudeLines(instance) {
            ...
            for (i = 0; i < length; i += 2) {
                ...
                if (when.defined(intersection)) {
                    ...
                    var offset = Ellipsoid.Cartesian3.multiplyByScalar(Ellipsoid.Cartesian3.UNIT_Y, 5.0 * _Math.CesiumMath.EPSILON9, offsetScratch);
                    if (p0.y < 0.0) {
                        Ellipsoid.Cartesian3.negate(offset, offset);
                    ...
                    var offsetPoint = Ellipsoid.Cartesian3.add(intersection, offset, offsetPointScratch);
                    ...
                    Ellipsoid.Cartesian3.negate(offset, offset);
                    Ellipsoid.Cartesian3.add(intersection, offset, offsetPoint);
        ...
        var cartesian3Scratch0 = new Ellipsoid.Cartesian3();
        var cartesian3Scratch2 = new Ellipsoid.Cartesian3();
        var cartesian3Scratch3 = new Ellipsoid.Cartesian3();
        var cartesian3Scratch4 = new Ellipsoid.Cartesian3();
        var cartesian3Scratch5 = new Ellipsoid.Cartesian3();
        var cartesian3Scratch6 = new Ellipsoid.Cartesian3();
        ...
        function updateAdjacencyAfterSplit(geometry) {
            ...
            for (var j = 0; j < length; j += 3) {
                var position = Ellipsoid.Cartesian3.unpack(positions, j, cartesian3Scratch0);
                if (position.x > 0.0) {
                    continue;
                }

                var prevPosition = Ellipsoid.Cartesian3.unpack(prevPositions, j, cartesian3Scratch2);
                if ((position.y < 0.0 && prevPosition.y > 0.0) || (position.y > 0.0 && prevPosition.y < 0.0)) {
                    if (j - 3 > 0) {
                        ...
                        Ellipsoid.Cartesian3.pack(position, prevPositions, j);
                    }
                }

                var nextPosition = Ellipsoid.Cartesian3.unpack(nextPositions, j, cartesian3Scratch3);
                if ((position.y < 0.0 && nextPosition.y > 0.0) || (position.y > 0.0 && nextPosition.y < 0.0)) {
                    if (j + 3 < length) {
                        ...
                        Ellipsoid.Cartesian3.pack(position, nextPositions, j);
                    }
                }
            }
        }
        ...
        function splitLongitudePolyline(instance) {
            ...
            for (i = 0; i < length; i += 4) {
                ...
                var p0 = Ellipsoid.Cartesian3.fromArray(positions, i0 * 3, cartesian3Scratch0);
                var p2 = Ellipsoid.Cartesian3.fromArray(positions, i2 * 3, cartesian3Scratch2);
                ...
                if (when.defined(intersection)) {
                    ...
                    // move point on the xz-plane slightly away from the plane
                    var offset = Ellipsoid.Cartesian3.multiplyByScalar(Ellipsoid.Cartesian3.UNIT_Y, offsetScalar, cartesian3Scratch5);
                    if (p0.y < 0.0) {
                        Ellipsoid.Cartesian3.negate(offset, offset);
                        p0Attributes = westGeometry.attributes;
                        p0Indices = westGeometry.indices;
                    ...
                    var offsetPoint = Ellipsoid.Cartesian3.add(intersection, offset, cartesian3Scratch6);
                    ...
                    var t = Ellipsoid.Cartesian3.magnitudeSquared(Ellipsoid.Cartesian3.subtract(intersection, p0, cartesian3Scratch3));
                    t /= Ellipsoid.Cartesian3.magnitudeSquared(Ellipsoid.Cartesian3.subtract(p2, p0, cartesian3Scratch3));
...
//# sourceMappingURL=GeometryPipeline-6475d5b1.js.map
