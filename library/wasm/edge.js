...
//wzl: 设置静态文件路径，用于适配webpack和browser版本
var wasmBinaryFile;
try{
    if(MOTOR_BASE_URL){
        if(MOTOR_BASE_URL[MOTOR_BASE_URL.length-1]==='/'){
            wasmBinaryFile = MOTOR_BASE_URL+'wasm/edge.wasm';
        }
        else{
            wasmBinaryFile = MOTOR_BASE_URL+'/wasm/edge.wasm';
        }
...
var real__getSize = asm["_getSize"]; asm["_getSize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getSize.apply(null, arguments);
};
...
var real__refuse = asm["_refuse"]; asm["_refuse"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__refuse.apply(null, arguments);
};
...
var _getSize = Module["_getSize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getSize"].apply(null, arguments) };
...
var _refuse = Module["_refuse"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_refuse"].apply(null, arguments) };
