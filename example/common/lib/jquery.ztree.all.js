  ...
  var settings = {}, roots = {}, caches = {},
    ...
    _consts = {
      ...
      node: {
        ...
        CURSELECTED_ICON:"curSelectedIcon"
      }
    },
    ...
    view = {
      ...
      cancelPreSelectedNode: function (setting, node, excludeNode) {
        ...
        for (i = list.length - 1; i >= 0; i--) {
          ...
          if (node === n || (!node && (!excludeNode || excludeNode !== n))) {
            ...
            $$(n, consts.id.ICON, setting).removeClass(consts.node.CURSELECTED_ICON);
            if (node) {
      ...
      selectNode: function (setting, node, addFlag) {
        ...
        $$(node, consts.id.ICON, setting).addClass(consts.node.CURSELECTED_ICON);
        ...
        function _docMouseMove(event) {
          ...
          if (root.dragFlag == 0) {
            ...
            for (i = 0, l = nodes.length; i < l; i++) {
              ...
              tmpDom.children("#" + tmpNode.tId + consts.id.ICON).removeClass(consts.node.CURSELECTED_ICON);
